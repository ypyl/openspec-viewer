...
- [ ] 3.3 Commit (1.1 + 2.1 + 3.2 together), push to `master`, wait for the GitHub Pages build (~1 min), and confirm the header badge reads v3.13.0 at https://ypyl.github.io/openspec-viewer/. No `screenshot.png` re-shoot needed (hotkey is not visual).