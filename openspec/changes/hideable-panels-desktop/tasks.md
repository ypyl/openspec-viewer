...
- [ ] 6.4 Commit everything (UI work and version bump together), push to `master`, wait for the GitHub Pages build (~1 min), and confirm the header badge reads v3.8.0 at https://ypyl.github.io/openspec-viewer/.
