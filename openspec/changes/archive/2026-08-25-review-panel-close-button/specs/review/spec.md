...
- **THEN** the review panel shows a close control on itself; activating it hides the panel, and activating the restore control defined by panel-visibility shows the panel again with its review list, checklist, and actions intact
