...
- [ ] 4.5 Commit everything (UI work, test updates, version bump, screenshot together), push to `master`, wait for the GitHub Pages build (~1 min), and confirm the header badge reads v3.9.0 at https://ypyl.github.io/openspec-viewer/.